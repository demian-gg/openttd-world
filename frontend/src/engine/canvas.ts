...
export function initializeCanvas(config: CanvasConfig): CanvasContext {
  ...
  applyCanvasResolution(canvas, context, resolution);

  // Store canvas context.
  canvasContext = { canvas, context, resolution };
...
export function handleCanvasResize(
  ...
  applyCanvasResolution(canvasContext.canvas, canvasContext.context, resolution);

  // Update stored resolution.
  canvasContext.resolution = resolution;
